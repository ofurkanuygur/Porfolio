...
const Window: React.FC<WindowProps> = ({
    ...
    return (
        ...
        >
            {/* Title Bar */}
            <div
                className="h-10 bg-transparent flex items-center justify-between px-4 select-none cursor-default flex-shrink-0"
                onDoubleClick={() => maximizeWindow(id)}
            >
                <div className="flex items-center gap-2 group" role="group" aria-label="Window controls">
                    <button
                        onClick={(e) => { e.stopPropagation(); closeWindow(id); }}
                        className="w-3.5 h-3.5 rounded-full bg-[#ff5f56] flex items-center justify-center hover:brightness-90 transition-all border border-black/10"
                    ...
                    <button
                        ...
                        className="w-3.5 h-3.5 rounded-full bg-[#ffbd2e] flex items-center justify-center hover:brightness-90 transition-all border border-black/10"
                    ...
                    <button
                        ...
                        className="w-3.5 h-3.5 rounded-full bg-[#27c93f] flex items-center justify-center hover:brightness-90 transition-all border border-black/10"
                ...
                <div className="font-medium text-sm flex-1 text-center mr-14" style={{ color: 'var(--text-primary)', opacity: 0.8 }}>
                    {title}
                </div>
            </div>
